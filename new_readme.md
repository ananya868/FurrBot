...
<p align="center">
  <img src="assets/home_page.png" width="850" alt="FurrBot Interface" />
</p>

## 🚀 Key Features

*   **RAG (Retrieval-Augmented Generation)**: Fetches real-time context from a verified knowledge base before generating answers.
*   **Multi-LLM Support**: Seamlessly switch between **OpenAI (GPT-4o)**, **Google (Gemini 1.5 Pro)**, **Anthropic (Claude 3.5 Sonnet)**, and **Mistral**.
*   **Vector Database**: Powered by **Pinecone** for high-speed similarity search and filtering.
*   **Namespace Filtering**: Precise retrieval based on pet categories (e.g., cats, dogs, reptiles).
*   **Modern UI**: A responsive, animated frontend built with **React**, **Tailwind CSS**, and **Framer Motion**.
*   **Scalable Backend**: Asynchronous API built with **FastAPI**.
*   **Health Monitoring**: `/health` endpoint tracks system uptime, memory usage, and component connectivity.
